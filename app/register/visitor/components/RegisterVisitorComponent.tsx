              ...
              >
                {({ errors, touched, values }) => (
                  <Form className="mt-14 p-10 flex flex-col justify-center max-w-[564px] w-full bg-white rounded-2xl">
                    ...
                    {step === 2 && (
                      <>
                        <FieldArray name="childInformation">
                          {({ insert, push, remove }) => (
                            <div>
                              {values.childInformation.length > 0 &&
                                values.childInformation.map((child, index) => (
                                  <div key={index}>
                                    ...
                                    <button
                                      type="button"
                                      className="hod_button mb-5 border rounded bg-red-700 text-white hover:bg-[#d64e30] transition-colors duration-300 ease-in-out"
                              ...
                              <button
                                type="button"
                                className="hod_button bg-[#273472] text-white hover:bg-[#5565b7] transition-colors duration-300 ease-in-out"
                                onClick={() => push(values.childInformation[0])}
                              >
                                Add Child
                              </button>
                              <br />
